...
PRETRAINED_CHECKPOINT_DIR=/home/yq/Downloads/IJCAI/checkpoints/mobilenet_v2

# Where the pre-trained Inception Resnet V2 checkpoint is saved to.
MODEL_NAME=mobilenet_v2_140

# Where the training (fine-tuned) checkpoint and logs will be saved to.
TRAIN_DIR=./logs/ten_filter_mobilenet_v2
...
CUDA_VISIBLE_DEVICES="1" python train_image_classifier.py \
  ...
  --checkpoint_path=${PRETRAINED_CHECKPOINT_DIR}/model.ckpt-402416 \
