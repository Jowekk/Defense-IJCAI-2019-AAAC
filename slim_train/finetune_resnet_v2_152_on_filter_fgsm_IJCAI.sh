...
PRETRAINED_CHECKPOINT_DIR=/home/yq/Downloads/IJCAI/checkpoints/resnet_v2_152
...
CUDA_VISIBLE_DEVICES="1" python train_image_classifier.py \
  --train_dir=${TRAIN_DIR} \
  --dataset_name=filter_fgsm_IJCAI \
  --dataset_split_name=train \
  --dataset_dir=${DATASET_DIR} \
  --model_name=${MODEL_NAME} \
  --checkpoint_path=${PRETRAINED_CHECKPOINT_DIR}/${MODEL_NAME}.ckpt \
#  --checkpoint_exclude_scopes=resnet_v2_152/logits,resnet_v2_152/AuxLogits \
