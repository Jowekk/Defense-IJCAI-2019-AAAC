...
PRETRAINED_CHECKPOINT_DIR=/home/yq/Downloads/IJCAI/checkpoints/inception_resnet

# Where the pre-trained Inception Resnet V2 checkpoint is saved to.
MODEL_NAME=inception_resnet_v2

# Where the training (fine-tuned) checkpoint and logs will be saved to.
TRAIN_DIR=./logs/inception_resnet_v2_filter_rand_IJCAI
...
CUDA_VISIBLE_DEVICES="0" python train_image_classifier.py \
  --train_dir=${TRAIN_DIR} \
  --dataset_name=filter_rand_IJCAI \
